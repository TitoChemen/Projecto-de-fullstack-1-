...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (facturacionRepository.count()== 0){
            Facturacion f1 = new Facturacion(null,1L, 15000.50, "FAC-992834-X", "2024-10-27");
            Facturacion f2 = new Facturacion(null,2L, 1490.99, "FAC-980027-X", "2023-06-01");
            Facturacion f3 = new Facturacion(null,3L, 145.50, "FAC-1027830-X", "2026-01-09");
