...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (inventarioRepository.count()== 0){
            Inventario i1 = new Inventario(null,50, "Pasillo A-12", "DISPONIBLE", null);
            Inventario i2 = new Inventario(null,0, "Pasillo b-12", "SIN_STROCK", null);
            Inventario i3 = new Inventario(null,21, "Pasillo A-2", "DISPONIBLE", null);
            Inventario i4 = new Inventario(null,89, "Pasillo C-4", "DISPONIBLE", null);
